...
function CollapsedSidebar() {
  return (
    <div className="fixed top-0 left-0 z-40 h-screen w-16 -translate-x-full overflow-y-auto transition-transform sm:translate-x-0">
      <ul className="space-y-2 font-medium">
        <li>
          <a
            href="#"
        ...
        <li>
          ...
          >
            ...
            <span className="ms-3 flex-1 whitespace-nowrap"></span>
          </a>
        </li>
        <li>
          <a
  ...
  return (
    <div className="relative">
      <button
        ...
        type="button"
        className="ms-3 mt-2 inline-flex items-center rounded-lg p-2"
      >
        <Hamburguer />
      </button>
      ...
      <aside
        className={`absolute top-0 left-0 h-full w-64 bg-gray-800 p-4 text-white transition-transform ${
